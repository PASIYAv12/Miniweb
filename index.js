...
// Function to convert YouTube video → mp3 link
async function ytmp3(url, quality = "64") {
  try {
...
const config = {
   WELCOME: 'true',
    ...
    AUTO_RECORDING: 'true',
    HEROKU_APP_URL: 'https://pppppm-8462788ee3dc.herokuapp.com/',
    AUTO_LIKE_EMOJI: ['💥', '👍', '😍', '💗', '🎈', '🎉', '🥳', '😎', '🚀', '🔥'],
    PREFIX: '.',
    MAX_RETRIES: 3,
    ...
    NEWSLETTER_JID: '120363402959594434@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,    OWNER_NUMBER: '94784548818',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbBPbHiGOj9gMKhd8Z3k'    
}


const octokit = new Octokit({ auth: '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' });
const owner = 'webscrape2003';
const repo = 'Pasiya-NEWS';
...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '👨‍💻PASIYA 𝐌𝐈𝐍𝐈 𝐌𝐃 𝐁𝐘 PASIDU sampath👨‍💻',
        `📞 Number: ${number}\n🩵 Status: Connected`,
        'POWERED_BUY Pasiya-md MINI BOT'
    );
...
/*async function updateAboutStatus(socket) {
    const aboutStatus = '👨‍💻POWERED_BUY Pasiya-md MINI BOT👨‍💻 //  Active 🚀';
    try {
...
async function updateStoryStatus(socket) {
    const statusMessage = `POWERED_BUY Pasiya-md MINI BOT Connected! 🚀\nConnected at: ${getSriLankaTimestamp()}`;
    try {
...
const welcomeText = `👋 *කොහොමද @${userId}*  

🇱🇰✨ 🗞️ POWERED_BUY Pasiya-md MINI BOT News 🗞️ වෙත සාදරයෙන් පිළිගනිමු – ශ්‍රී ලංකා පුවත් මධ්‍යස්ථානය! ✨🇱🇰

ආයුබෝවන් 🙏 සහ නව සාමාජිකයන් සැමට උණුසුම් පිළිගැනීමක්! 🌸
මෙම අවකාශය නිර්මාණය කර ඇත්තේ ඔබට නවතම පුවත්, ඉක්මන් තොරතුරු සහ ශ්‍රී ලංකාවේද, ලොව පුරා ඇති වැදගත් කතාන්තර එකම විශ්වාසනීය සමාජයකින් ලබා දීම සඳහාය.

💬 මෙහිදී ඔබට කළ හැක්කේ:
✅ විශ්වාසනීය පුවත් බෙදාගැනීම
✅ නව විෂයන් ගැන සාකච්ඡා කිරීම
✅ විවිධ අදහස් ගරු කිරීම
✅ නවතම තොරතුරු සමඟ එකට සිටීම

අපි එකට සත්‍යය, ගරුභාවය සහ අවබෝධය මූලික කරගත් සමාජයක් ගොඩනගමු.
ඔබ මෙහි රැඳී සිටීම අපට සතුටක්! 🌍📰

📌 නවතම දැනුමෙන් සිටින්න, සම්බන්ධව සිටින්න, එකට එකමුතුවෙන් සිටින්න.
`
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: 'POWERED_BUY Pasiya-md MINI BOT is running',
